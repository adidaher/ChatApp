...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = getIntent();
        //getting the user if from the adapter activity when current user click in view holder to send message to this recieved id
    ...
    private void sendMessage(String sender ,final String reciever ,  String message){
        ...
        final DatabaseReference chatRef = FirebaseDatabase.getInstance().getReference("Chatlist")
                .child(fuser.getUid()).child(reciever);
